<div class="container-fluid">
   <div class="row">
      <div class="col-lg-12">
         <div class="user-nav">
            <a href="sales_assigned.php"><button class="h-btn"><i class="fa fa-arrow-left"></i>Home</button></a>
            <a href="no_answer.php">
               <button class="na-btn"> <i class="nadirer fa-solid fa-stopwatch"></i>No answer</button>
            </a>
            <a href="said_no.php">
